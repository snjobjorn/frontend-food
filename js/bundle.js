    ...
    function showThanksModal(message) {
        ...
        thanksModal.innerHTML = `
            <div class="modal__content">
                ...
                <dic class="modal__title">${message}</div>
            </div>
        `;
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function slider({container, nextArrow, prevArrow, totalCounter, currentCounter, slide}) {
    // Slider
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2022-05-28');
